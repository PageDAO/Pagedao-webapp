...
const BookClubs = () => {
  ...
  const filteredBookClubs = bookClubs.filter(club => 
    ...
    club.book.toLowerCase().includes(searchTerm.toLowerCase())
  );
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {activeTab === 'overview' && (
        <div className="space-y-6">
          <section>
            <h2 className="text-2xl font-semibold mb-2">NFT-Powered Book Clubs</h2>
            <p>Our book clubs are unique, NFT-powered communities where book owners can create and join exclusive discussion groups. Each club is tied to a specific book NFT, ensuring authentic and engaged conversations.</p>
          </section>
          <section>
            <h2 className="text-2xl font-semibold mb-2">How It Works</h2>
            <ol className="list-decimal list-inside space-y-2">
              <li><strong>Own a Book NFT:</strong> Purchase or mint an NFT of your favorite book on Base Mainnet.</li>
              <li><strong>Create or Join a Club:</strong> Start a new club for your book or join an existing one.</li>
              <li><strong>Purchase Access Tokens:</strong> Buy PAGE tokens to join clubs for books you don't own.</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>Potential for increased value of your book NFTs</li>
              <li>Direct engagement with authors and publishers</li>
            </ul>
          </section>
          <section>
            <h2 className="text-2xl font-semibold mb-2">Bonding Curve Mechanism</h2>
            <p>Our book clubs use a bonding curve to determine the price of access tokens. This means:</p>
            <ul className="list-disc list-inside space-y-2">
      ...
      {activeTab === 'clubs' && (
        <div>
          <h2 className="text-2xl font-semibold mb-4">Active Book Clubs</h2>
          <input
            type="text"
            placeholder="Search book clubs or books"
            value={searchTerm}
          ...
          <ul className="space-y-4">
            {filteredBookClubs.map((club) => (
              <li key={club.id} className="border rounded-lg p-4">
                ...
                <p className="text-gray-600">Book: {club.book}</p>
      ...
      {activeTab === 'create' && (
        <div>
          <h2 className="text-2xl font-semibold mb-4">Create a New Book Club</h2>
          <p className="mb-4">To create a new book club:</p>
          <ol className="list-decimal list-inside space-y-2">
            <li>Ensure you own the NFT of the book you want to create a club for</li>
            <li>Click the "Create Club" button below</li>
            <li>Select the book NFT you want to use</li>
